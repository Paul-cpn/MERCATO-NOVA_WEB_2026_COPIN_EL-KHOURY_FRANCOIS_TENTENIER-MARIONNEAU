...
function FavorisPage() {
  ...
  return (
    <div>
      ...
      <main className="main">
        <h2 className="section-title" style={{textAlign: 'left', marginBottom: '30px', fontWeight: '800', paddingLeft: '20px'}}>
          Mes Favoris
        </h2>
        ...
        {!loading && articles.length === 0 && (
          <div style={{ textAlign: 'center', padding: '80px 0' }}>
            <img 
              src="../images/coeur_casser.png" 
              alt="Aucun favori" 
              style={{ width: '100px', height: '100px', opacity: 0.4, marginBottom: '20px', display: 'block', margin: '0 auto 20px auto' }} 
            />
            <p style={{ fontSize: '18px', color: '#666', marginBottom: '15px' }}>
              Vous n'avez pas encore d'articles en favoris.
            </p>
            <a href="index.html" style={{ color: '#e4ca3e', fontWeight: '700', textDecoration: 'none' }}>
